...
original_dir = '/home/postman/dl_project_tanna/train+val/validation/Hurricane/'
corrupted_dir = '/home/postman/dl_project_tanna/train+val/validation/Hurricane_paired/'

# Path to save the processed images
output_dir = '/home/postman/dl_project_tanna/impainted_dataset/validation/hurricane/'
...
for file in file_list:
    ...
    if os.path.isfile(original_path) and os.path.isfile(corrupted_path):
        ...
        if original_image is not None and corrupted_image is not None:
            ...
            result = cv2.inpaint(corrupted_image, (mask/255).astype('uint8'), inpaintRadius=4, flags=cv2.INPAINT_TELEA)
